...
#define DebugSerial Serial2 //Debug output on serial3 TX pin
#else //arduino UNO and others
#define SimEngineSerialPort Serial
...
void setup()
{
  ...
  else { //We are managing a sabertooth 2*25 or lower which allows 38400 bps
...
void menuUseEvent(MenuUseEvent used)
{
  ...
  {
    SabertoothType = LCDChangeValDouble(SabertoothType, 2, 1, 1); //1=2.25 2=2.32
    WriteEEValues();
    menu.moveRight();
  }
...
void PrintValues() {
  ...
  DebugSerial.println(F("Var\t\t\t Address\tsize\tval"));
  DebugSerial.print(F("EEInit\t\t\t")); DebugSerial.print(addrXPIDVersion); DebugSerial.print("\t\t"); DebugSerial.print(sizeof(XPIDVersion)); DebugSerial.print("\t"); DebugSerial.print(EEPROM.readInt(addrXPIDVersion)); DebugSerial.println("");
  DebugSerial.print(F("FeedbackMax1\t\t")); DebugSerial.print(addrFeedbackMax1); DebugSerial.print("\t\t"); DebugSerial.print(sizeof(FeedbackMax1)); DebugSerial.print("\t"); DebugSerial.print(FeedbackMax1); DebugSerial.println("");
  DebugSerial.print(F("FeedbackMin1\t\t")); DebugSerial.print(addrFeedbackMin1); DebugSerial.print("\t\t"); DebugSerial.print(sizeof(FeedbackMin1)); DebugSerial.print("\t"); DebugSerial.print(FeedbackMin1); DebugSerial.println("");
  DebugSerial.print(F("FeedbackMax2\t\t")); DebugSerial.print(addrFeedbackMax2); DebugSerial.print("\t\t"); DebugSerial.print(sizeof(FeedbackMax2)); DebugSerial.print("\t"); DebugSerial.print(FeedbackMax2); DebugSerial.println("");
  DebugSerial.print(F("FeedbackMin2\t\t")); DebugSerial.print(addrFeedbackMin2); DebugSerial.print("\t\t"); DebugSerial.print(sizeof(FeedbackMin2)); DebugSerial.print("\t"); DebugSerial.print(FeedbackMin2); DebugSerial.println("");
  DebugSerial.print(F("FeedbackPotDeadZone1\t")); DebugSerial.print(addrFeedbackPotDeadZone1); DebugSerial.print("\t\t"); DebugSerial.print(sizeof(FeedbackPotDeadZone1)); DebugSerial.print("\t"); DebugSerial.print(FeedbackPotDeadZone1); DebugSerial.println("");
  DebugSerial.print(F("FeedbackPotDeadZone2\t")); DebugSerial.print(addrFeedbackPotDeadZone2); DebugSerial.print("\t\t"); DebugSerial.print(sizeof(FeedbackPotDeadZone2)); DebugSerial.print("\t"); DebugSerial.print(FeedbackPotDeadZone2); DebugSerial.println("");
  DebugSerial.print(F("K_motor_1\t\t")); DebugSerial.print(addrK_motor_1); DebugSerial.print("\t\t"); DebugSerial.print(sizeof(K_motor_1)); DebugSerial.print("\t"); DebugSerial.print(K_motor_1); DebugSerial.println("");
  DebugSerial.print(F("proportional1\t\t")); DebugSerial.print(addrproportional1); DebugSerial.print("\t\t"); DebugSerial.print(sizeof(proportional1)); DebugSerial.print("\t"); DebugSerial.print(proportional1); DebugSerial.println("");
  DebugSerial.print(F("integral1\t\t")); DebugSerial.print(addrintegral1); DebugSerial.print("\t\t"); DebugSerial.print(sizeof(integral1)); DebugSerial.print("\t"); DebugSerial.print(integral1); DebugSerial.println("");
  DebugSerial.print(F("derivative1\t\t")); DebugSerial.print(addrderivative1); DebugSerial.print("\t\t"); DebugSerial.print(sizeof(derivative1)); DebugSerial.print("\t"); DebugSerial.print(derivative1); DebugSerial.println("");
  DebugSerial.print(F("K_motor_2\t\t")); DebugSerial.print(addrK_motor_2); DebugSerial.print("\t\t"); DebugSerial.print(sizeof(K_motor_2)); DebugSerial.print("\t"); DebugSerial.print(K_motor_2); DebugSerial.println("");
  DebugSerial.print(F("proportional2\t\t")); DebugSerial.print(addrproportional2); DebugSerial.print("\t\t"); DebugSerial.print(sizeof(proportional2)); DebugSerial.print("\t"); DebugSerial.print(proportional2); DebugSerial.println("");
  DebugSerial.print(F("integral2\t\t")); DebugSerial.print(addrintegral2); DebugSerial.print("\t\t"); DebugSerial.print(sizeof(integral2)); DebugSerial.print("\t"); DebugSerial.print(integral2); DebugSerial.println("");
  DebugSerial.print(F("derivative2\t\t")); DebugSerial.print(addrderivative2); DebugSerial.print("\t\t"); DebugSerial.print(sizeof(derivative2)); DebugSerial.print("\t"); DebugSerial.print(derivative2); DebugSerial.println("");
  DebugSerial.print(F("DeadZone\t\t")); DebugSerial.print(addrDeadZone); DebugSerial.print("\t\t"); DebugSerial.print(sizeof(DeadZone)); DebugSerial.print("\t"); DebugSerial.print(DeadZone); DebugSerial.println("");
  DebugSerial.print(F("ReadAnalog\t\t")); DebugSerial.print(addrReadAnalog); DebugSerial.print("\t\t"); DebugSerial.print(sizeof(ReadAnalog)); DebugSerial.print("\t"); DebugSerial.print(ReadAnalog); DebugSerial.println("");
  DebugSerial.print(F("SabertoothType\t\t")); DebugSerial.print(addrSabertoothType); DebugSerial.print("\t\t"); DebugSerial.print(sizeof(SabertoothType)); DebugSerial.print("\t"); DebugSerial.print(SabertoothType); DebugSerial.println("");
#endif
}
