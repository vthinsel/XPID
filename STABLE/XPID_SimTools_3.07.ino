...
int addrSabertoothType = EEPROM.getAddress(sizeof(ReadAnalog));
...
void menuUseEvent(MenuUseEvent used)
{
  ...
  {
    Motor1STDBY  = LCDChangeValInt(Motor1STDBY , 1023, 0, 2);
    WriteEEValues();
    menu.moveRight();
  }
  if (used.item == menu_stdby_motor_2) 
  {
    Motor2STDBY  = LCDChangeValInt(Motor2STDBY , 1023, 0, 2);
    WriteEEValues();
    menu.moveRight();
  }
