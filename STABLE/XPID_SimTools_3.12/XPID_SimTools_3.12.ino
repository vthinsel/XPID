...
void SetPWM()
{
  if ((abs(target1 - currentanalogue1) <= (DeadZone + FeedbackPotDeadZone1)) || (currentanalogue1 >= FeedbackMax1) ||(currentanalogue1 <= FeedbackMin1 ) ) {
    PowerM1 = 0;
  } else {
    PowerM1 = int(OutputM1 / 2);;
  }
  if ((abs(target2 - currentanalogue2) <= (DeadZone + FeedbackPotDeadZone2))|| (currentanalogue2 >= FeedbackMax2) ||(currentanalogue2 <= FeedbackMin2 ) ) {
    PowerM2 = 0;
  } else {
