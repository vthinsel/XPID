...
void PrintEEValues() {
  ...
  Serial.println("--------------");
  Serial.println("Var\t\t\t Address\tsize\tval");
  Serial.print("EEInit\t\t\t"); Serial.print(addrEEInit); Serial.print("\t\t"); Serial.print(sizeof(int)); Serial.print("\t"); Serial.print(EEPROM.readInt(addrEEInit)); Serial.println("");
  Serial.print("FeedbackMax1\t\t"); Serial.print(addrFeedbackMax1); Serial.print("\t\t"); Serial.print(sizeof(FeedbackMax1)); Serial.print("\t"); Serial.print(EEPROM.readInt(addrFeedbackMax1)); Serial.println("");
  Serial.print("FeedbackMin1\t\t"); Serial.print(addrFeedbackMin1); Serial.print("\t\t"); Serial.print(sizeof(FeedbackMin1)); Serial.print("\t"); Serial.print(EEPROM.readInt(addrFeedbackMin1)); Serial.println("");
  Serial.print("FeedbackMax2\t\t"); Serial.print(addrFeedbackMax2); Serial.print("\t\t"); Serial.print(sizeof(FeedbackMax2)); Serial.print("\t"); Serial.print(EEPROM.readInt(addrFeedbackMax2)); Serial.println("");
  Serial.print("FeedbackMin2\t\t"); Serial.print(addrFeedbackMin2); Serial.print("\t\t"); Serial.print(sizeof(FeedbackMin2)); Serial.print("\t"); Serial.print(EEPROM.readInt(addrFeedbackMin2)); Serial.println("");
  Serial.print("FeedbackPotDeadZone1\t"); Serial.print(addrFeedbackPotDeadZone1); Serial.print("\t\t"); Serial.print(sizeof(FeedbackPotDeadZone1)); Serial.print("\t"); Serial.print(EEPROM.readInt(addrFeedbackPotDeadZone1)); Serial.println("");
  Serial.print("FeedbackPotDeadZone2\t"); Serial.print(addrFeedbackPotDeadZone2); Serial.print("\t\t"); Serial.print(sizeof(FeedbackPotDeadZone2)); Serial.print("\t"); Serial.print(EEPROM.readInt(addrFeedbackPotDeadZone2)); Serial.println("");
  Serial.print("K_motor_1\t\t"); Serial.print(addrK_motor_1); Serial.print("\t\t"); Serial.print(sizeof(K_motor_1)); Serial.print("\t"); Serial.print(EEPROM.readDouble(addrK_motor_1)); Serial.println("");
  Serial.print("proportional1\t\t"); Serial.print(addrproportional1); Serial.print("\t\t"); Serial.print(sizeof(proportional1)); Serial.print("\t"); Serial.print(EEPROM.readDouble(addrproportional1)); Serial.println("");
  Serial.print("integral1\t\t"); Serial.print(addrintegral1); Serial.print("\t\t"); Serial.print(sizeof(integral1)); Serial.print("\t"); Serial.print(EEPROM.readDouble(addrintegral1)); Serial.println("");
  Serial.print("derivative1\t\t"); Serial.print(addrderivative1); Serial.print("\t\t"); Serial.print(sizeof(derivative1)); Serial.print("\t"); Serial.print(EEPROM.readDouble(addrderivative1)); Serial.println("");
  Serial.print("K_motor_2\t\t"); Serial.print(addrK_motor_2); Serial.print("\t\t"); Serial.print(sizeof(K_motor_2)); Serial.print("\t"); Serial.print(EEPROM.readDouble(addrK_motor_2)); Serial.println("");
  Serial.print("proportional2\t\t"); Serial.print(addrproportional2); Serial.print("\t\t"); Serial.print(sizeof(proportional2)); Serial.print("\t"); Serial.print(EEPROM.readDouble(addrproportional2)); Serial.println("");
  Serial.print("integral2\t\t"); Serial.print(addrintegral2); Serial.print("\t\t"); Serial.print(sizeof(integral2)); Serial.print("\t"); Serial.print(EEPROM.readDouble(addrintegral2)); Serial.println("");
  Serial.print("derivative2\t\t"); Serial.print(addrderivative2); Serial.print("\t\t"); Serial.print(sizeof(derivative2)); Serial.print("\t"); Serial.print(EEPROM.readDouble(addrderivative2)); Serial.println("");
  Serial.print("DeadZone\t\t"); Serial.print(addrDeadZone); Serial.print("\t\t"); Serial.print(sizeof(DeadZone)); Serial.print("\t"); Serial.print(EEPROM.readInt(addrDeadZone)); Serial.println("");
  Serial.print("ReadAnalog\t\t"); Serial.print(addrReadAnalog); Serial.print("\t\t"); Serial.print(sizeof(addrReadAnalog)); Serial.print("\t"); Serial.print(EEPROM.readInt(addrReadAnalog)); Serial.println("");
}
...
void PrintValues() {
  Serial.println("------------");
  Serial.println("Current Vars");
  Serial.println("------------");
  Serial.println("Var\t\t\t Address\tsize\tval");
  Serial.print("EEInit\t\t\t"); Serial.print(addrEEInit); Serial.print("\t\t"); Serial.print(sizeof(int)); Serial.print("\t"); Serial.print(EEPROM.readInt(addrEEInit)); Serial.println("");
  Serial.print("FeedbackMax1\t\t"); Serial.print(addrFeedbackMax1); Serial.print("\t\t"); Serial.print(sizeof(FeedbackMax1)); Serial.print("\t"); Serial.print(FeedbackMax1); Serial.println("");
  Serial.print("FeedbackMin1\t\t"); Serial.print(addrFeedbackMin1); Serial.print("\t\t"); Serial.print(sizeof(FeedbackMin1)); Serial.print("\t"); Serial.print(FeedbackMin1); Serial.println("");
  Serial.print("FeedbackMax2\t\t"); Serial.print(addrFeedbackMax2); Serial.print("\t\t"); Serial.print(sizeof(FeedbackMax2)); Serial.print("\t"); Serial.print(FeedbackMax2); Serial.println("");
  Serial.print("FeedbackMin2\t\t"); Serial.print(addrFeedbackMin2); Serial.print("\t\t"); Serial.print(sizeof(FeedbackMin2)); Serial.print("\t"); Serial.print(FeedbackMin2); Serial.println("");
  Serial.print("FeedbackPotDeadZone1\t"); Serial.print(addrFeedbackPotDeadZone1); Serial.print("\t\t"); Serial.print(sizeof(FeedbackPotDeadZone1)); Serial.print("\t"); Serial.print(FeedbackPotDeadZone1); Serial.println("");
  Serial.print("FeedbackPotDeadZone2\t"); Serial.print(addrFeedbackPotDeadZone2); Serial.print("\t\t"); Serial.print(sizeof(FeedbackPotDeadZone2)); Serial.print("\t"); Serial.print(FeedbackPotDeadZone2); Serial.println("");
  Serial.print("K_motor_1\t\t"); Serial.print(addrK_motor_1); Serial.print("\t\t"); Serial.print(sizeof(K_motor_1)); Serial.print("\t"); Serial.print(K_motor_1); Serial.println("");
  Serial.print("proportional1\t\t"); Serial.print(addrproportional1); Serial.print("\t\t"); Serial.print(sizeof(proportional1)); Serial.print("\t"); Serial.print(proportional1); Serial.println("");
  Serial.print("integral1\t\t"); Serial.print(addrintegral1); Serial.print("\t\t"); Serial.print(sizeof(integral1)); Serial.print("\t"); Serial.print(integral1); Serial.println("");
  Serial.print("derivative1\t\t"); Serial.print(addrderivative1); Serial.print("\t\t"); Serial.print(sizeof(derivative1)); Serial.print("\t"); Serial.print(derivative1); Serial.println("");
  Serial.print("K_motor_2\t\t"); Serial.print(addrK_motor_2); Serial.print("\t\t"); Serial.print(sizeof(K_motor_2)); Serial.print("\t"); Serial.print(K_motor_2); Serial.println("");
  Serial.print("proportional2\t\t"); Serial.print(addrproportional2); Serial.print("\t\t"); Serial.print(sizeof(proportional2)); Serial.print("\t"); Serial.print(proportional2); Serial.println("");
  Serial.print("integral2\t\t"); Serial.print(addrintegral2); Serial.print("\t\t"); Serial.print(sizeof(integral2)); Serial.print("\t"); Serial.print(integral2); Serial.println("");
  Serial.print("derivative2\t\t"); Serial.print(addrderivative2); Serial.print("\t\t"); Serial.print(sizeof(derivative2)); Serial.print("\t"); Serial.print(derivative2); Serial.println("");
  Serial.print("DeadZone\t\t"); Serial.print(addrDeadZone); Serial.print("\t\t"); Serial.print(sizeof(DeadZone)); Serial.print("\t"); Serial.print(DeadZone); Serial.println("");
  Serial.print("ReadAnalog\t\t"); Serial.print(addrReadAnalog); Serial.print("\t\t"); Serial.print(sizeof(addrReadAnalog)); Serial.print("\t"); Serial.print(ReadAnalog); Serial.println("");
}
...
void setup()
{
  ...
  if (EEPROM.readInt(addrEEInit) != VERSION) {
    Serial.println("EEPROM empty or layout changed. Updating it");
    lcd.setCursor(0, 0);
    lcd.print("Upgrade EEPROM");
    InitEEValues();
    delay(1000);
    lcd.setCursor(0, 1);
    lcd.print("Done.");
